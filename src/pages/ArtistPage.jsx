...
export default function ArtistPage() {
  ...
  if (loading) return <div className="public-shell"><PublicNav /><div className="catalog-state">Loading artist…</div></div>;
  if (error) return <div className="public-shell"><PublicNav /><div className="catalog-state error" role="alert">{error}</div></div>;
  if (!artist) return <div className="public-shell"><PublicNav /><div className="catalog-state">Virtual Artist not found.</div></div>;
  return (
